...
class Task(object):
	...
	def index(self):
		...
		tasks = ['<div class="header">Tasklist for : <span class="highlight">%s</span><form class="logoff" action="%s" method="GET"><button type="submit" name="logoffurl" class="logoff-button" value="/">Log off</button></form></div>'%(username,self.logoffpath),
